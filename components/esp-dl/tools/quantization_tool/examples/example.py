...
if __name__ == "__main__":
    ...
    pickle_file_path = 'M1_calib.pickle'
    ...
    calib.export_coefficient_to_cpp(model_proto, pickle_file_path, 'esp32s3', '.', 'custom_coefficient', True)

    # Evaluate the performance
    print('Evaluating the performance on esp32s3:')
    eva = Evaluator('int8', 'per-tensor', 'esp32s3')

...
public:
    ...
    Custom() : //l1(Transpose<int8_t>({}, "l0")),
              ...
              l3(Conv2D<int8_t>(-4, get_sequential_conv2d_1_biasadd_filter(), get_sequential_conv2d_1_biasadd_bias(), NULL, PADDING_SAME_END, {}, 1, 1, "l3")),
              l4(MaxPool2D<int8_t>({3, 3}, PADDING_VALID, {}, 2, 2, "l4")),
              l5(Conv2D<int8_t>(-3, get_sequential_conv2d_2_biasadd_filter(), get_sequential_conv2d_2_biasadd_bias(), NULL, PADDING_SAME_END, {}, 1, 1, "l5")),
              l6(Conv2D<int8_t>(-2, get_sequential_conv2d_3_biasadd_filter(), get_sequential_conv2d_3_biasadd_bias(), NULL, PADDING_SAME_END, {}, 1, 1, "l6")),
              l7(Conv2D<int8_t>(0, get_sequential_conv2d_4_biasadd_filter(), get_sequential_conv2d_4_biasadd_bias(), NULL, PADDING_SAME_END, {}, 1, 1, "l7")),
              l8(MaxPool2D<int8_t>({3, 3}, PADDING_VALID, {}, 2, 2, "l8")),
              l9(Transpose<int8_t>({}, "l9")),
              l10(Reshape<int8_t>({1, 1, 256}, "l10")),
              l11(Conv2D<int8_t>(0, get_fused_gemm_0_filter(), get_fused_gemm_0_bias(), get_fused_gemm_0_activation(), PADDING_SAME_END, {}, 1, 1, "l11")),
              l12(Conv2D<int8_t>(0, get_fused_gemm_1_filter(), get_fused_gemm_1_bias(), get_fused_gemm_1_activation(), PADDING_SAME_END, {}, 1, 1, "l12")),
              l13(Conv2D<int8_t>(0, get_fused_gemm_2_filter(), get_fused_gemm_2_bias(), NULL, PADDING_SAME_END, {}, 1, 1, "l15")),
